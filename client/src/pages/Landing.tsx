    ...
    <div className='bg-background min-h-screen relative overflow-hidden text-text-primary font-sans'>
      ...
      <section className='py-32 px-6 relative'>
         ...
         <div className='max-w-4xl mx-auto text-center relative z-10 space-y-8'>
            ...
            <Button size='lg' className='text-xl px-12 py-8 shadow-[0_0_40px_rgba(0,240,255,0.5)] hover:shadow-[0_0_60px_rgba(0,240,255,0.8)] transition-shydow duration-500'>
              ACCEPT INVITATION
            </Button>
         </div>
      </section>
